...
async def test_browser_manager_navigate():
    ...
    mock_config.get.side_effect = lambda k, d=None: (
        "https://example.com" if k == "target_url" else (30 if k == "navigation_timeout_seconds" else d)
    )
    ...
    with patch("src.core.browser.get_config_manager", return_value=mock_config):
        ...
        mock_page.goto.assert_called_with("https://test.com", wait_until="domcontentloaded", timeout=30000)
